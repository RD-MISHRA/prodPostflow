      ...
      <div class="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between relative z-10">
        <div class="md:w-1/2 text-center md:text-left mb-12 md:mb-0">
          <h1 class=" md:text-5xl font-extrabold leading-tight mb-6">
            Grow your Content <br><span class="text-blue-500 underline decoration-wavy decoration-2 text-5xl">on Social Media</span>
          </h1>
  ...
  <button class="bg-blue-500 text-black px-8 py-4 rounded-full text-lg font-semibold flex items-center gap-3 hover:bg-blue-600 transition transform hover:scale-105 shadow-lg">
    ...
    <span>Rate us on GitHub</span>
          ...
          <div class="flex items-center mt-6 text-gray-500 text-sm">
            <span class="mr-4">⭐ 4.7/5 on G2</span>
            <span>💳 No credit card required</span>
          </div>
        </div>

        <!-- Images / Mockups -->
        <div class="md:w-1/2 relative flex justify-center md:justify-end items-center ">
          <img src="https://i.postimg.cc/vTJXtmKZ/Chat-GPT-Image-Jun-28-2025-09-25-37-PM.png" class="rounded-lg">
          
          <!-- <img src="https://i.postimg.cc/wT0NgZwW/Screenshot-2025-06-28-211535.png">

          <img src="https://i.postimg.cc/wT0NgZwW/Screenshot-2025-06-28-211535.png"> -->

          <div class="absolute top-1/4 left-1/4 w-32 h-32 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
          <div class="absolute bottom-1/4 right-1/4 w-32 h-32 bg-blue-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
        </div>
      </div>
    </header>
